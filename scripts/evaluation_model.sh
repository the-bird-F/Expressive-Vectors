...
EVAL="./dataset/MagicData_use/ref_sichuan_eval.csv"
BASE="./dataset/MagicDialect"

SEED=0
NFE=32
RESULT_DIR="ref_changsha_eval/seed${SEED}_euler_nfe${NFE}_vocos_ss-1_cfg2.0_speed1.0"

python ./expressive_vector/model_action.py \
            --model_dir "ckpts/${DataName}" \
            --model2 $BEST_MODEL \
            --alpha $BEST_A


accelerate launch ./expressive_vector/my_eval_infer.py \
    -s $SEED \
